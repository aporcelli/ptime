    ...
    return [
      {
        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://apis.google.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https://lh3.googleusercontent.com https://avatars.githubusercontent.com https://ssl.gstatic.com; connect-src 'self' https://oauth2.googleapis.com https://apis.google.com; frame-src 'self' https://docs.google.com; frame-ancestors 'none';"
          },
        ],
      },
    ];
