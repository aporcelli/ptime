...
export default function ReporteTemplate({ className = "", label = "Exportar PDF", ...docProps }: ButtonProps) {
  ...
  return (
    ...
    >
      {({ loading }) => (
        <span
          className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all cursor-pointer bg-primary text-white hover:bg-primary-container ${
